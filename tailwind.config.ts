    ...
    theme: {
      extend: {
        colors: {
          ...
          // Warm text colors
          text: {
            DEFAULT: '#8D2F00', // Deep warm brown for text
            primary: '#8D2F00',
            secondary: '#BF360C', // Medium warm brown
            tertiary: '#E64100',
            muted: '#FF7043',
        ...
        boxShadow: {
          ...
          // Coral glow effects
          'glow-coral': '0 0 20px rgba(255, 138, 101, 0.6), 0 0 40px rgba(255, 138, 101, 0.4), 0 0 80px rgba(255, 138, 101, 0.2)',
          'glow-coral-lg': '0 0 30px rgba(255, 138, 101, 0.7), 0 0 60px rgba(255, 138, 101, 0.5), 0 0 120px rgba(255, 138, 101, 0.3)',
          'glow-coral-xl': '0 0 40px rgba(255, 138, 101, 0.8), 0 0 80px rgba(255, 138, 101, 0.6), 0 0 160px rgba(255, 138, 101, 0.4)',
          // Warm sunset multi-layer glow
          'sunset': '0 0 20px rgba(255, 107, 53, 0.8), 0 0 40px rgba(255, 138, 101, 0.6), 0 0 80px rgba(255, 171, 145, 0.4)',
          'sunset-lg': '0 0 30px rgba(255, 107, 53, 0.9), 0 0 60px rgba(255, 138, 101, 0.7), 0 0 120px rgba(255, 171, 145, 0.5)',
          // Cozy warmth effects
          ...
          'inner-glow-coral': 'inset 0 2px 4px 0 rgba(255, 138, 101, 0.2)',
          // Soft warm shadows
        ...
        keyframes: {
          ...
          'coral-glow': {
            '0%': { 
              boxShadow: '0 0 20px rgba(255, 138, 101, 0.6), 0 0 40px rgba(255, 138, 101, 0.4)' 
            },
            '100%': { 
              boxShadow: '0 0 30px rgba(255, 138, 101, 0.8), 0 0 60px rgba(255, 138, 101, 0.6)' 
            },
          },
          'intense-glow': {
            '0%': { 
        ...
        backgroundImage: {
          ...
          'gradient-warm': 'linear-gradient(135deg, rgba(255, 107, 53, 0.1) 0%, rgba(255, 138, 101, 0.1) 100%)',
          'gradient-sunset': 'linear-gradient(45deg, rgba(255, 107, 53, 0.05) 0%, rgba(255, 171, 145, 0.05) 50%, rgba(255, 138, 101, 0.05) 100%)',
